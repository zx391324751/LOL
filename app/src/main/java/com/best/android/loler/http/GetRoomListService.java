 ...
 */
public class GetRoomListService extends BaseHttpService {
    ...
    public GetRoomListService(Context context){
        this.context = context;
    }

    public void send(ResponseListener listener, int roomId, int offset) {
        this.responseListener = listener;
        AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
        asyncHttpClient.setTimeout(TIME_OUT);
        RequestParams requestParams = new RequestParams();
        asyncHttpClient.get(context, NetConfig.getRoomListUrl(roomId, offset), requestParams, responseHandler);
    }
